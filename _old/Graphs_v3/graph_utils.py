...
def generate_apartments(graph, desired_proportions, generation_settings, ranking_settings, circulation_bounds, maximum_floor, fill, iteration):
    ...
    while len(start_nodes) > 0:
        ...
        for target in possible_targets:
            ...
            ranking_functions = get_ranking_functions(graph, ranking_settings, possible_apartments, circulation_bounds, maximum_floor, graph_data)
...
def get_ranking_functions(the_graph, rank_settings, possible_apartments, circulation_bounds, max_floor, graph_data):
    """
    ...
    if "_compacity" in rank_settings:
        compacities = (graph_data.min_compacity, graph_data.max_compacities_dict)
